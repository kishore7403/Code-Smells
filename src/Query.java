...
public class Query {
    ...
    public int createQuery(UserData userData, String query, String[] security,FileOperations fileOperations) throws IOException {
...
//            System.out.println(this.fileOperations.value);
    ...
    public void deleteTable(UserData userData, String query, String[] security) throws IOException {
        String[] queryElements = query.split(" ");
        String tableName = queryElements[2].replace(";", "");
        File myObj = new File(String.format("%s-%s.txt", tableName, userData.getUserId()));
        myObj.delete();
